...
public class GetLabelResponse extends AbstractResponse {

    private final GetLabelResponseData data;

    public GetLabelResponse(GetLabelResponseData data) {
        super(ApiKeys.forId(data.apiKey()));
        this.data = data;
    }

    public GetLabelResponseData data() {
        return data;
    }

    public static GetLabelResponse parse(ByteBuffer buffer, short version) {
        return new GetLabelResponse(
                new GetLabelResponseData(new ByteBufferAccessor(buffer), version)
        );
    }
