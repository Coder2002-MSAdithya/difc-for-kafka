...
public class Topic {
    ...
    public static final String DIFC_REQUESTS_TOPIC_NAME = "__difc_requests";
    ...
    private static final Set<String> INTERNAL_TOPICS = Set.of(GROUP_METADATA_TOPIC_NAME, TRANSACTION_STATE_TOPIC_NAME, SHARE_GROUP_STATE_TOPIC_NAME, DIFC_REQUESTS_TOPIC_NAME);
